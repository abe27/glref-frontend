                ...
                <div className="flex w-96 space-x-4">
                  ...
                  <>
                    <Input
                      ...
                      type="text"
                      readOnly
                      value={`${entData?.book.fccode}-${entData?.book.fcname}`}
                    />
                  </>
                </div>
                <div className="flex w-96 space-x-4">
                  ...
                  <>
                    <Input
                      ...
                      type="text"
                      readOnly
                      value={`${entData?.to_whouse.fccode.replace(
                        /^\s+|\s+$/gm,
                        ""
                      )}-${entData?.to_whouse.fcname.replace(
                        /^\s+|\s+$/gm,
                        ""
                      )}`}
                    />
                ...
                <div className="flex w-96 space-x-4">
                  ...
                  <>
                    <Input
                      ...
                      type="text"
                      readOnly
                      value={`${entData?.coor.fcname.replace(
                        /^\s+|\s+$/gm,
                        ""
                      )}`}
                    />
                ...
                <div className="flex space-x-4">
                  ...
                  <>
                    <Input
                      ...
                      type="text"
                      readOnly
                      value={`${entData?.department.fcname.replace(
                        /^\s+|\s+$/gm,
                        ""
                      )}`}
                    />
              ...
              <div className="flex w-full space-x-4 pt-2">
                ...
                <div className="w-48">
                  <Input
                    ...
                    type="text"
                    readOnly
                    value={`${entData?.fmmemdata.replace(/^\s+|\s+$/gm, "")}`}
                  />
                </div>
