...
const AdjustPage = () => {
  ...
  const fetchData = async () => {
    ...
    const res = await fetch(
      `${process.env.API_HOST}/glHistory?fctype=GR`,
      requestOptions
    );
  ...
  return (
    <MainLayOut
      title="ใบเบิงสินค้า GR"
      description="รายการใบเบิกสินค้าประเภท GR"
    >
      <>
            ...
            <div className="flex justify-end">
              <div className="flex justify-between space-x-4">
                <Tooltip content="เพิ่มรายการใหม่">
                  <Link href={`/gr/add?title=เพิ่มรายการเบิกสินค้า`}>
                    <Button
                      size={"md"}
                      auto
                      color={"primary"}
              ...
              <Table.Body>
                {data?.map((i, x) => (
                  <Table.Row key={x}>
                    ...
                    <Table.Cell>
                      <Link
                        href={`/gr/detail?is_add=false&edit=${
